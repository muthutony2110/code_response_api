...
def generate():
    try:
        ...
        # Build context for LLM using **entire task history**
        history = get_history_by_task(user_id, task_name, limit=10)  # Fetch all history for this task
